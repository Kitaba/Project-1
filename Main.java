...
public class Main {
    ...
    private static void printHelp() {
        System.out.print("Order introduction:\n\n1. Movement order\n\tAn order contains two parts.\n\tThe first part is number from 1 to 8,they are refer to 鼠(1),猫(2),狼(3),狗(4),豹(5),虎(6),狮(7),象(8) according to battle level.\n\tThe second part is one of the letter from wasd,w refers up,a refers left,s refers down,d refers right\n\tFor example: \"1d\" means mouse go right, \"4w\" dog go upwards\n\n2. Game order:\n\tInput restart to restart the game.\n\tInput u to undo，input r to redo.\n\tInput end to exit .\n\tInput help to see help message.\n\n");
    }
